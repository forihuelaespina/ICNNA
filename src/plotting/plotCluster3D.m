function [h]=plotCluster3D(Y,c)
%Plots a cluster
% A convinient function for easy visualization of a cluster in a 3D space
%
% h=plotCluster3D(pointsCoordinates,cluster) Visualize the cluster
...
if get(c,'ShowAverageDistance')
    ...
    h(5)=circle(centroid(1:2),get(c,'AverageDistance'),tempOpt);
end
