...
%
% 14-Mar-2026: FOE
%   + Bug fixed. In copy constructor from icnna.data.core.timeline
%   the extraction of the events' .info was only passing the "first"
%   event rather than the info for all events.
%
