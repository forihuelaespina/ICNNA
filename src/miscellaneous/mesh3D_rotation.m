function [g]=mesh3D_rotation(g,theta,par1,par2)
%Rotate a 3D mesh about an arbitrary axes
%
% [g]=mesh3D_rotation(g,theta,p1,p2) Rotate a 3D mesh theta angles
%	about an arbitrary axes specified by 2 points p1 and p2.
%
% [g]=mesh3D_rotation(g,theta,alpha,beta) Rotate a 3D mesh theta angles
...
%% Algorithm
%
% The axis of rotation can be located anywhere (6 d.o.f.).
...
% @date: 23-Mar-2009
%
% See also mesh3D_scale, mesh3D_traslation
%
...
%Step 3: Rotate object around Z axes by angle theta
