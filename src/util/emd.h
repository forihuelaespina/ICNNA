...
/* DEFINITIONS */
#define MAX_SIG_SIZE   500 //Modified by FOE (8-Jun-07): Original value=300
#define MAX_ITERATIONS 10000 //Modified by FOE (8-Jun-07): Original value=500
#define INFINITY       1e20
#define EPSILON        1e-6

/*****************************************************************************/
/* feature_t SHOULD BE MODIFIED BY THE USER TO REFLECT THE FEATURE TYPE      */
typedef int feature_t; //Modified by FOE (8-Jun-07): Original type = int
/*****************************************************************************/
